...
public class DriverServiceImpl implements DriverService {
    ...
    public DriverLoginVo getDriverLoginVo(Long driverId) {
        ...
        return driverLoginInfoResult.getData();
    }

    @Override
    public DriverAuthInfoVo getDriverAuthInfo(Long driverId) {
        Result<DriverAuthInfoVo> driverAuthInfoResult = driverInfoFeignClient.getDriverAuthInfo(driverId);
        return driverAuthInfoResult.getData();
    }
